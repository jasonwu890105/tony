...
thingName = "door1"
awsEndpoint = "a20hc5kskyvso0-ats.iot.ap-northeast-1.amazonaws.com"
awsPortNumber = 8883
awsRootCAPath = "./AmazonRootCA1.pem"
awsIoTPrivateKeyPath = "./Abhradeep_certs/fced045933-private.pem.key"
awsIoTCertificatePath = "./Abhradeep_certs/fced045933-certificate.pem.crt"
...
def thread_function(epochTime):
    while True:
       ...
       if stopThread :
            break
       if (int(time.time() - epochTime)/10) >=1 :
